...
Look at the first cell in open set
is it our goal cell?
yes? end
No? Remove from the openset. Add all the cells directly next to, to the openset (above, under, and next to)
Check all the cell in the openset, and calculate their distance (distance is the parent node+distance+manhatten distance) to the goal.
*/
